<?php
namespace Application\Theme\Jolt;
...
class PageTheme extends Theme implements ThemeProviderInterface
{
    ...
    {
        return t('A Vibrant Brands Page Theme');
    }
    ...
    {
        return [
            ['title' => t('Drop Shadow'), 'menuClass' => '', 'spanClass' => 'drop-shadow', 'forceBlock' => '-1'],
            ['title' => t('Orange Link'), 'menuClass' => '', 'spanClass' => 'orange-link', 'forceBlock' => '-1'],
            ['title' => t('Orange Button'), 'menuClass' => '', 'spanClass' => 'orange-btn', 'forceBlock' => '-1'],
            ['title' => t('Blue Gradient Button'), 'menuClass' => '', 'spanClass' => 'blue-btn', 'forceBlock' => '-1'],
            ['title' => t('Orange Header'), 'menuClass' => '', 'spanClass' => 'orange-header', 'forceBlock' => '-1'],
            ['title' => t('Byline'), 'menuClass' => '', 'spanClass' => 'byline', 'forceBlock' => '-1']
        ];
    }
