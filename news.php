...
<div class="internal content">
  ...
  <div class="knowledge-exchange container">
    ...
    <div class="results">
      ...
      $list->filterByPageTypeHandle('news_item');
      ...
      foreach($pages as $page) {
        ...
        <div class="news-item <?php echo $lowercase ?>">
          ...
          <div class="text">
            <h2><a href="/knowledge-exchange/news/<?php echo $url ?>"><?php echo $pagename ?></a></h2>
            <small class="categories"><?php echo $categories; ?></small>
            <p><?php echo $description ?></p>
            <span class="orange-link"><a href="/knowledge-exchange/news/<?php echo $url ?>">Read more &raquo;</a></span>
          </div>
        </div>
      <?php } ?>
    </div>
